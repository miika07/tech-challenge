...
export class Database1705899584761 implements MigrationInterface {
    name = 'Database1705899584761'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`pedidos\` (\`id\` varchar(36) NOT NULL, \`status\` varchar(255) NOT NULL, \`numeroPedido\` int NOT NULL AUTO_INCREMENT, \`idCliente\` varchar(36) NULL, UNIQUE INDEX \`IDX_0d6429b8b067916cc704ee1f2f\` (\`numeroPedido\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
